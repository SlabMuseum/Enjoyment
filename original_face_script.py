...
facial_data_path = r"C:\Users\TomSch101\Desktop\135\_FaceExpressionData_24.12.23_16-20.csv"

logs_data_path = r"C:\Users\TomSch101\Desktop\135\TAUXR_Logs_24.12.23_16-21.csv"
...
entered_zone_logs = logs_data[logs_data['LogText'].str.contains("Player entered the zone of", na=False, case=False)]
...
emotion_to_aus = {
    ...
    "joy": {
        ...
        'CheekRaiserL': 2.0, 'CheekRaiserR': 2.0,

        'LipCornerPullerL': 2.5, 'LipCornerPullerR': 2.5

    },

    "sadness": {

        'InnerBrowRaiserL': 1.2, 'InnerBrowRaiserR': 1.2,

        'BrowLowererL': 0.5, 'BrowLowererR': 0.5,
    ...
    "anger": {
        ...
        'BrowLowererL': 1.5, 'BrowLowererR': 1.5,

        'LidTightenerL': 1.8, 'LidTightenerR': 1.8

    },

    "disgust": {

        'NoseWrinklerL': 2.0, 'NoseWrinklerR': 2.0,

        'LipCornerDepressorL': 1.0, 'LipCornerDepressorR': 1.0
    ...
    "surprise": {
        ...
        'UpperLidRaiserL': 2.0, 'UpperLidRaiserR': 2.0,
...
def calculate_intensity_weighted(max_values, aus_weights, min_threshold=0.1):
    ...
    return (intensity_sum / weight_sum) * 100 if weight_sum > 0 else 0
...
for _, row in first_entry_per_painter.iterrows():
    ...
    # Compute valence using proportional scaling between 0 and 100

    valence = 50 + (max_emotion_intensity / 100) * 50 if strongest_emotion == "joy" else 50 - (max_emotion_intensity / 100) * 50
